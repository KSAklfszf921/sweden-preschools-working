...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      Förskolor: {
        Row: {
          ...
          "Andel med förskollärarlegitimation": number | null
          "Antal barn": number | null
          "Antal barn per grupp, snitt": number | null
          "Antal barngrupper": number
          "Antal heltidstjänster": number | null
          geo_point: unknown | null
          Huvudman: Database["public"]["Enums"]["huvudman_type"]
          id: string
          Kommun: string
          Kommunkod: number
          Latitud: number | null
          ...
          skolverkets_id: number
          x_sweref: number | null
    ...
    Views: {
      ...
      v_forskolor_geo: {
        Row: {
          ...
          geo_point: unknown | null
          huvudman: Database["public"]["Enums"]["huvudman_type"] | null
          id: string | null
          kommun: string | null
          latitud: number | null
          longitud: number | null
      ...
      v_forskolor_public_stats: {
        Row: {
          antal_forskolor: number | null
          genomsnitt_barn: number | null
          genomsnitt_examen: number | null
          genomsnitt_personaltathet: number | null
          huvudman: Database["public"]["Enums"]["huvudman_type"] | null
          kommun: string | null
          kommunkod: number | null
          totalt_barn: number | null
        }
        Relationships: []
      }
      v_forskolor_stats: {
    ...
    Enums: {
      huvudman_type: "Kommunal" | "Enskild"
      storlek_kategori: "Liten" | "Medium" | "Stor" | "Mycket stor"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
